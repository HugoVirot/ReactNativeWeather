...
const ChangeNameScreen = props => {
    ...
    return (
        <View style={styleSheet.container}>
            ...
            <Text>Nom choisi : {name}</Text>
            {/* <Text>Nom choisi : {this.props.userName}</Text> affiche this is undefined*/}
        </View>
    );
}
...
// ne marche pas (this is undefined)
...
// export default connect(mapState)(ChangeNameScreen);
export default connect(({ user }) => ({ user }))(ChangeNameScreen);
// export default connect(({ meteo }) => ({ meteo }))(EditScreen);